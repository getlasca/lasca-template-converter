...
test("vertical flex wrap", () => {
  ...
  expect(output.css).toBe(
    ".breakpoint-1 { position: relative; } " +
      ".class-1 { background-color: rgba(255,255,255,1); }" +
      ".class-2 { background-color: rgba(255,255,255,1); box-sizing: border-box; display: flex; flex-direction: column; padding-top: 0px; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; flex-wrap: wrap; column-gap: 50px; justify-content: flex-start; row-gap: 0px; align-items: flex-start; position: absolute; top: 100px; min-height: 500px; left: 100px; width: 500px; }" +
      ".class-3 { background-color: rgba(255,255,255,1); width: 100%; height: 500px; position: relative; }"
  );
});
